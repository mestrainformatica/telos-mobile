...
angular.module('ngwindow.Keyboard', [])
  ...
  .factory('$cordovaKeyboard', ['$rootScope', function ($rootScope) {
    ...
    return {
      hideAccessoryBar: function (bool) {
        return window.Keyboard.hideKeyboardAccessoryBar(bool);
      },

      close: function () {
        return window.Keyboard.close();
      },

      show: function () {
        return window.Keyboard.show();
      },

      disableScroll: function (bool) {
        return window.Keyboard.disableScroll(bool);
      },
