...
window.controller = angular
  ...
  .controller('initMenu', [
    ...
    '$ionicPopup',
    '$ionicModal',
    function ($scope, $state, $rootScope, $http, $ionicLoading, $ionicPopup, $ionicModal) {
      ...
      if (cordova && window.plugins.touchid && touchId === 'NAO') {
        new Promise(function (resolve, reject) {
          ...
          window.plugins.touchid.isAvailable(function () {
             ...
             $ionicModal.fromTemplateUrl('templates/modal/touchId-cadastrar.html', {
                  scope: $scope,
