...
function ConectPrevMestra() { 
   ...
   var logMsg = "";
	...
	ConectPrevMestra.gravarDadosParaEnvioCP = function() {   
   	try {
			var funcionalidadeAtiva = ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11));
   ...
   ConectPrevMestra.exibirImagem = function() {   
		...
		funcionalidadeTemConecPrev = ConectPrevMestra.ConnectCookie.get("funcionalidadeTemConecPrev"+document.URL.substring(0,document.URL.indexOf("atendimento")+11), "false");
		if (funcionalidadeTemConecPrev == "true" && document.URL.indexOf("selecaopopup=S") == -1){
				objDivLogo.style.display  = "";
		}
   }
      	...
      	if (tipoDados) {
			if (tipoDados.value == "inicio") {  
	            ...
	            if (temConectPrev) if (temConectPrev.value == "sim") {   
	            	ConectPrevMestra.ConnectCookie.set("funcionalidadeTemConecPrev"+document.URL.substring(0,document.URL.indexOf("atendimento")+11), "true");
						ConectPrevMestra.exibirImagem();
						ConectPrevMestra.ConnectCookie.set("objFuncaoArray", objFuncaoArray.toString());
						ConectPrevMestra.ConnectCookie.set("objCampoArray", objCampoArray.toString());
	            } else {   
						// N?o tem conect prev para esta funcionalidade
	               ConectPrevMestra.ConnectCookie.set("funcionalidadeTemConecPrev"+document.URL.substring(0,document.URL.indexOf("atendimento")+11), "false");
						ConectPrevMestra.exibirImagem();
	            }
   ...
   ConectPrevMestra.enviarRespostaParaConectPrevMestra = function(dadosResposta) {
        if (ConectPrevMestra.criarHttpRequest()) {   
            var params = "cliente=" + codigoCliente + "&chave=resposta&funcionalidade="+ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11)) +"&urlKey="+document.URL.substring(0,document.URL.indexOf("atendimento")+11);
   ...
   ConectPrevMestra.verificaSeTemConectPrevMestra = function(funcionalidadeAtiva) {	
		if (ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11)) != funcionalidadeAtiva) {
	        ConectPrevMestra.ConnectCookie.set("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11), funcionalidadeAtiva);
	        if (ConectPrevMestra.criarHttpRequest() && document.forms[0].usuarioUltAlteracao) {   
				var params = "cliente=" + codigoCliente + "&chave=inicio&funcionalidade="+ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11)) +"&urlKey="+document.URL.substring(0,document.URL.indexOf(".do"));
				xmlhttpcp.onreadystatechange = function(){ ConectPrevMestra.processadorMudancaEstado(); };
   ...
   ConectPrevMestra.inicializarGrupoConectPrevMestra = function(funcionalidadeAtiva) {
        if (ConectPrevMestra.criarHttpRequest() && document.forms[0].usuarioUltAlteracao) {   
			var params = "cliente=" + codigoCliente + "&chave=inicio&funcionalidade="+ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11)) + "&usuarioUltAlteracao="+document.forms[0].usuarioUltAlteracao.value+"&urlKey="+document.URL.substring(0,document.URL.indexOf("atendimento")+11);
			xmlhttpcp.onreadystatechange = function(){ ConectPrevMestra.processadorMudancaEstado(); };
			logMsg = logMsg + "*** verificaSeTemConectPrevMestra ***\n";
			logMsg = logMsg + "Host : " + hostConectPrevMestra + "\n";
			logMsg = logMsg + "Paramteros : " + params + "\n";
    ...
    ConectPrevMestra.verificaSeOperacaoEfetuada = function(operacaoRealizada) {
		var strObjArray = ConectPrevMestra.ConnectCookie.get("objFuncaoArray");
    ...
    ConectPrevMestra.enviarDadosParaConectPrevMestra = function(operacao, funcionalidadeAtiva) {
        ...
        if (ConectPrevMestra.criarHttpRequest()) {
            var params = "cliente=" + codigoCliente + "&chave=fim&funcionalidade="+ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11)) + "&operacao=" + operacao + strUrl+"&urlKey="+document.URL.substring(0,document.URL.indexOf("atendimento")+11);
				xmlhttpcp.onreadystatechange = function(){ ConectPrevMestra.processadorMudancaEstado(); };
    ...
    ConectPrevMestra.enviarMsg = function() {	
	        ...
	        if (ConectPrevMestra.criarHttpRequest() && document.forms[0].usuarioUltAlteracao) {   
				var params = "cliente=" + codigoCliente + "&chave=envio&funcionalidade="+ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11)) + "&usuarioUltAlteracao="+document.forms[0].usuarioUltAlteracao.value+"&urlKey="+document.URL.substring(0,document.URL.indexOf("atendimento")+11);
				xmlhttpcp.onreadystatechange = function(){ ConectPrevMestra.processadorMudancaEstado(); };
				logMsg = logMsg + "*** verificaSeTemConectPrevMestra ***\n";
				logMsg = logMsg + "Host : " + hostConectPrevMestra + "\n";
				logMsg = logMsg + "Paramteros : " + params + "\n";
    ...
    ConectPrevMestra.recuperaFuncionalidade = function() {   
        ...
        if (pos > 0) {
			...
			var strFuncAtiva = ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11));
    ...
    ConectPrevMestra.recuperaRespostaOperacao = function() {
        ...
        var indexURLX = document.URL.indexOf("evento=Abrir");
        var indexURLY = document.URL.indexOf("evento=Incluir");
        ...
        if(document.forms[0].modoPlc)
        	modoPlc = document.forms[0].modoPlc.value;
        
        /*
         * modoPlc == "consultaPlc") = "contorno técnico" feito para atender apenas o Syscall 
         * var indexURLX = document.URL.indexOf("evento=Abrir"); = "contorno técnico" feita para atender apenas o Syscall 
         * 
         * Felipe Reis
         */
        if (index > 0 || index2 > 0){
            return "001";
        }else if((indexURLY > 0 || indexURLX > 0 &&  modoPlc == "inclusaoPlc" || modoPlc == "consultaPlc" || indexURLX > 0 && modoPlc == "inclusaoPlc") || indexURLEditar > 0 || indexClone > 0 || indexExcl > 0){
        	return "002";
        }else{
            return "000";
        }
    ...
    ConectPrevMestra.executaConectPrevMestra = function() {
		...
		if (ConectPrevMestra.ConnectCookie.get("funcionalidadeAtiva"+document.URL.substring(0,document.URL.indexOf("atendimento")+11).substring(0,document.URL.indexOf(".do"))) == funcionalidadeAtiva)
			ConectPrevMestra.exibirImagem();
