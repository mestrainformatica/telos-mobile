...
// Image1.src = "/Mestra_Syscall/plc/midia/menuExpandable_images/plus.gif"

// Image2= new Image(9,9)
// Image2.src = "/Mestra_Syscall/plc/midia/menuExpandable_images/minus.gif"


// Image3= new Image(9,9)
// Image3.src = "/Mestra_Syscall/plc/midia/menuExpandable_images/square.gif"
...
function initializeMenu(menuId, actuatorId) {
    ...
    //actuator.parentNode.style.backgroundImage = "url(/Mestra_Syscall/plc/midia/menuExpandable_images/plus.gif)";
    actuator.onclick = function() {
        var display = menu.style.display;
        // this.parentNode.style.backgroundImage =
        //     (display == "block") ? "url(/Mestra_Syscall/plc/midia/menuExpandable_images/plus.gif)" : "url(/Mestra_Syscall/plc/midia/menuExpandable_images/minus.gif)";
...
function openMenu(menuId) {
    ...
    if (menu != null) {
        var display = menu.style.display;
        // menu.parentNode.style.backgroundImage = "url(/Mestra_Syscall/plc/midia/menuExpandable_images/minus.gif)";
        // menu.style.display = (display == "block") ? "none" : "block";
