...
/* 
 * @author: S?rgio Chaves - Mestra Inform?tica 2003 
 * Ajustes : Juscelino Cunha Coelho em 17-04-2009
*/
//onkeypress="return sonumero(event)"

function sonumeroBase(e, strCheck, fld) {
	var key = '';
	var whichCode = (window.Event) ? e.which : e.keyCode;
	if (whichCode == 13) return true;  // Enter
	if (whichCode == 8) return true;  // BackSpace
	...
	if (strCheck.indexOf(key) == -1) 
		...
		if (key == '-' && fld != null && fld.value.length > 0) 
			return false;  // Not a valid key
}

function sonumero(e) {
	return sonumeroBase(e, '0123456789,', null);
}
...
function sonumeroPosNeg(e, fld) {
	return sonumeroBase(e, '-0123456789,', fld);
}
...
/**
 Funcao Criada para corrigir o "bug do 1 centavo" e o "bug das casas decimais".
 Recomendado para numeros pequenos.
@author Andr?
*/
...
//==============================================================================
//================== FUN??O PARA DESABILITAR CARACTER ESPECIAL =================

function desabilitaCaracterEspecial(e) {
	var key = '';
...
//==============================================================================
//===================== FUN??O PARA CRIAR M?CARA PARA O CPF ====================
