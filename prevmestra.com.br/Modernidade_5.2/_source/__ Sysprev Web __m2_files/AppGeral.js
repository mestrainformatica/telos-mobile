...
if (vDateValue == "~") {
	swal("AppVersion = "+navigator.appVersion+" \nNav. 4 Version = "+isNav4+" \nNav. 5 Version = "+isNav5+" \nIE Version = "+isIE4+" \nYear Type = "+vYearType+" \nDate Type = "+vDateType+" \nSeparator = "+strSeperator);
vDateName.value = "";
vDateName.focus();
return true;
}
...
//	if(valorDigitado == '') {
//		swal("Digite o n?mero do PIS/PASEP");
//		objeto.focus();
//		return;
//	}
	
	if ((!validaPIS(eval("'" + valorDigitado.substring(0,14) + "'"), eval("'" + valorDigitado.substring(14,15) + "'")))){
		swal("O PIS/PASEP: " + valorDigitado + " ? inv?lido");
		objeto.value = '';
//		objeto.focus();
		return;
//	} else {
//		swal("O PIS/PASEP: " + valorDigitado + " ? v?lido");
//		objeto.focus();
//		return;
//    }
	}
...
function confirmaNovo(acao){
	swal({
      title: "Deseja incluir um novo registro ?",
