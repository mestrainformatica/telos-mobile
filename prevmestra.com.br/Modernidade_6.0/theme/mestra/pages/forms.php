											...
											<div class="kt-portlet__body">
												<div class="kt-section kt-section--first">
													<div class="form-group">
														...
														<input type="email" class="form-control" placeholder="Insira seu nome completo">
														<span class="form-text text-muted">Insira seu nome completo</span>
													</div>
													<div class="form-group">
														<label>Email:</label>
														<input type="email" class="form-control" placeholder="Insira seu email">
														<span class="form-text text-muted">Não compartilharemos seu email com mais ninguém</span>
													</div>
													<div class="form-group">
								...
								<div class="col-lg-6">
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													Layout de formulário horizontal
												</h3>
											</div>
										</div>
										...
										<form class="kt-form">
											<div class="kt-portlet__body">
												<div class="kt-section kt-section--first">
													<h3 class="kt-section__title">1. Informações do consumidor:</h3>
													<div class="kt-section__body">
														<div class="form-group row">
															<label class="col-lg-3 col-form-label">Nome completo:</label>
															<div class="col-lg-6">
																<input type="email" class="form-control" placeholder="Insira seu nome completo">
																<span class="form-text text-muted">Por favor insira seu nome completo</span>
															</div>
														</div>
														<div class="form-group row">
													...
													<h3 class="kt-section__title">2. Conta do consumidor:</h3>
													<div class="kt-section__body">
														<div class="form-group row">
															<label class="col-lg-3 col-form-label">Gerente:</label>
															<div class="col-lg-6">
																<input type="email" class="form-control" placeholder="Insira o nome completo">
																<span class="form-text text-muted">Informe o nome do seu gerente</span>
															</div>
														</div>
														<div class="form-group row">
														...
														<div class="form-group row">
															<label class="col-lg-3 col-form-label">Communicação:</label>
															<div class="col-lg-6">
